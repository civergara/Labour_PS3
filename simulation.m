...
% Measurement Shocks
shocksEta=normrnd(0,ssigmaEta,n,50);
...
if shocksXi(i,1)>=thresholdXi(1,1)
    decision(i,1)=1;
    experience(i,2)=1;
    wage(i,1)=exp(meanWage(1)+shocksXi(i,1)+shocksEta(i,1));
end
...
while t<50
    if shocksXi(i,t)<thresholdXi(experience(i,t)+1,t)
        ...
        wage(i,t)=exp(meanWage(experience(i,t)+1)+shocksXi(i,t)+shocksEta(i,t));
    end
    t=t+1;
end
